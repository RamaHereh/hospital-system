                                        ...
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($laboratories as $laboratory)
                                               <tr>
                                                   ...
                                                   <td>{{$laboratory->laboratory_emp_id !==null ? $laboratory->laboratoryEmp->name:'لا يوجد حتى الآن'}}</td>
                                                   <td>{{$laboratory->description_emp}}</td>
                                                   <td>
                                                       @if($laboratory->laboratory_emp_id !== null)
