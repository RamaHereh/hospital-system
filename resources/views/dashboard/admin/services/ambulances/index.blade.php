...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الإسعاف</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ سيارات الاسعاف</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
                                    <a href="{{route('ambulances.create')}}" class="btn btn-primary">اضافة سيارة جديدة</a>
								</div>
							</div>
							<div class="card-body">
									...
									<table class="table text-md-nowrap" id="example1">
                                        ...
                                        @foreach($ambulances as $ambulance)
											<tr>
                                                ...
                                                <td><div
                                                class="dot-label bg-{{$ambulance->is_available == 1 ? 'success':'danger'}} ml-1"></div> {{$ambulance->is_available == 1 ? 'مفعلة': 'غير مفعلة'}}</td>
                                            ...
                                            @include('dashboard.admin.services.ambulances.delete')
                                        @endforeach
										</tbody>
									</table>
								</div>
