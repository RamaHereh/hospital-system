        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('insurance_companies.update',$insuranceCompany)}}" method="post">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="insurance_code" value="{{$insuranceCompany->insurance_code}}"
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="name" value="{{$insuranceCompany->name}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="number" name="discount_percentage" value="{{$insuranceCompany->discount_percentage}}"
                            ...
                            <div class="col">
                                ...
                                <input type="number" name="company_rate"
                                    value="{{$insuranceCompany->company_rate}}"  class="form-control @error ('Company_rate') is-invalid @enderror">
                                @error('Company_rate')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea rows="5" cols="10" class="form-control"
                                          name="notes">{{$insuranceCompany->notes}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <label>حالة التفعيل</label>
                                 &nbsp;
                                <input name="status" {{$insuranceCompany->status == 1 ? 'checked' : ''}} value="1" type="checkbox" class="form-check-input" id="exampleCheck1">
                            </div>
                        </div>
