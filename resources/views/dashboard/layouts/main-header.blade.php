                                    ...
                                    <form method="POST" action="{{ route('admin.logout') }}">
                                        @elseif(auth('doctor')->check())
                                            <form method="POST" action="{{ route('doctor.logout') }}">
                                                @elseif(auth('ray_emp')->check())
                                                    <form method="POST" action="{{ route('ray-emp.logout') }}">
                                                        @elseif(auth('laboratory_emp')->check())
                                                            <form method="POST"
                                                                  action="{{ route('laboratory-emp.logout') }}">
                                                                @else
                                                                    <form method="POST"
...
<script>
    ...
    Echo.private('create-invoice.{{ auth()->user()->id }}').listen('.create-invoice', (data) => {
       ...
       <div class="notification-subtext">`+data.createdAt+`</div>`;
        new_message.show();
