<!-- Deleted insurance -->
<div class="modal fade" id="delete_laboratory{{$patient_laboratory->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('doctor-laboratories.destroy', $patient_laboratory->id) }}" method="post">
                    @method('DELETE')
                    @csrf
                    <div class="row">
                        <div class="col">
